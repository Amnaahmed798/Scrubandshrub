...
const sidebarItems: SidebarItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: 'Accepted', href: '/admin/bookings/accepted' },
      { label: 'Completed', href: '/admin/bookings/completed' },
      { label: 'Canceled', href: '/admin/bookings/canceled' }
    ]
  },
  {
    icon: Wrench,
...
export default function DesktopSidebar() {
  ...
  return (
    <div className={`hidden lg:block border-r bg-white h-full transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
      {/* Sidebar header */}
